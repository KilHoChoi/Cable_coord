...
for i in range(1,10):
    ...
    theta_WPTOP = sp.atan(dy.subs({alpha: alpha_tmp, xA: X_WP3_tmp, xB: X_WPTOP, x:X_WPTOP}))
    theta_WP3 = sp.atan(dy.subs({alpha: alpha_tmp, xA: X_WP3_tmp, xB: X_WPTOP, x:X_WP3_tmp}))
